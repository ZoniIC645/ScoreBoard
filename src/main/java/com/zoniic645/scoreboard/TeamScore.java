...
public class TeamScore extends WorldSavedData {
    public static final String ANSI_CYAN = "\u001B[36m";//색좀 줘보려고. 의미있는건 아님
    ...
    public void readFromNBT(NBTTagCompound compound) {
        System.out.println(ANSI_CYAN + "WorldSavedData : NBT데이터 뽑아서 적용시킹 : " + compound.getShort("teamUID") + ANSI_CYAN);
    ...
    public NBTTagCompound writeToNBT(NBTTagCompound compound) {
        System.out.println(ANSI_CYAN + "WorldSavedData : NBT 데이터에 저장함 : " + team.getUID() + ANSI_CYAN);
    ...
    public static TeamScore getTeamScore(World world, ForgeTeam teamIn) {
        ...
        TeamScore Instance = (TeamScore) storage.getOrLoadData(TeamScore.class, teamscorenameIn); //스토리지에서 팀스코어를 꺼내서 넣어줘요x
